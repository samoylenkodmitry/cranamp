...
- Use RustRover MCP for all code search, analysis, refactoring and edits; pass `projectPath`. Read [IDE workflow](docs/agent-workflow.md) before code work. Shell is for build/test/git.
