"""Small native lettering vocabulary shared by the Silverplay22 artists."""
from connected_canvas import CanvasPen
FONT={'0':['111','101','101','101','111'],'1':['010','110','010','010','111'],'2':['110','001','111','100','111'],'3':['110','001','010','001','110'],'4':['101','101','111','001','001'],'5':['111','100','110','001','110'],'6':['011','100','111','101','111'],'7':['111','001','010','010','010'],'8':['111','101','111','101','111'],'9':['111','101','111','001','110'],
...
class LetterPen(CanvasPen):
    def glyph(self,text,x,y,color):
        for ch in text:
            self.stamp(x,y,FONT.get(ch,["000"]*5),{"1":color})
            x+=4
