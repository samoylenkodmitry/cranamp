...
pub const EQ_ON_BUTTON_OFF: SpriteRect = (10.0, 119.0, 25.0, 12.0);
pub const EQ_ON_BUTTON_OFF_SELECTED: SpriteRect = (128.0, 119.0, 25.0, 12.0);
pub const EQ_ON_BUTTON_ON: SpriteRect = (69.0, 119.0, 25.0, 12.0);
pub const EQ_ON_BUTTON_ON_SELECTED: SpriteRect = (187.0, 119.0, 25.0, 12.0);
pub const EQ_AUTO_BUTTON_OFF: SpriteRect = (35.0, 119.0, 33.0, 12.0);
pub const EQ_AUTO_BUTTON_OFF_SELECTED: SpriteRect = (153.0, 119.0, 33.0, 12.0);
pub const EQ_AUTO_BUTTON_ON: SpriteRect = (94.0, 119.0, 33.0, 12.0);
pub const EQ_AUTO_BUTTON_ON_SELECTED: SpriteRect = (212.0, 119.0, 33.0, 12.0);
...
pub const POS_EQ_AUTO_BUTTON: (f32, f32) = (39.0, 18.0);
...
pub const PLAYLIST_TOP_LEFT_CORNER: SpriteRect = (0.0, 0.0, 25.0, 20.0);
pub const PLAYLIST_TOP_TILE: SpriteRect = (127.0, 0.0, 25.0, 20.0);
pub const PLAYLIST_TITLE_BAR: SpriteRect = (26.0, 0.0, 100.0, 20.0);
pub const PLAYLIST_TOP_RIGHT_CORNER: SpriteRect = (153.0, 0.0, 25.0, 20.0);
