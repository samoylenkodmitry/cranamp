...
const BUNDLED_SKINS: &[BundledSkin] = &[
    ...
    BundledSkin {
        id: "moonlit",
        label: "Catamp Catnip (Bundled)",
        bytes: include_bytes!("../../assets/skins/Catamp Catnip.wsz"),
    },
    BundledSkin {
        id: "moon-garden",
...
fn DocumentPickerEffect(state: MutableState<WinampState>) {
    ...
    cranpose_core::LaunchedEffect(pending.clone(), move |_scope| match pending {
        None => {}
...
#[cfg(test)]
#[path = "../../test/unit/winamp/tests.rs"]
mod tests;

#[cfg(test)]
#[path = "../../test/unit/winamp/dock_tests.rs"]
mod dock_tests;
